...
class PitchForm(FlaskForm):
    ...
    category = SelectField('Category', choices=[('Choose Category', 'Choose Category'),('Love', 'Love'),('business', 'business pitch'),('Interview Pitch', 'Interview Pitch'),('Political Pitch', 'Political Pitch')])
